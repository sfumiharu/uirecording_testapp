...
SWIFT_CLASS("_TtC6InvApp11AppDelegate")
...
SWIFT_CLASS("_TtC6InvApp14ViewController")
@interface ViewController : UIViewController
@property (nonatomic) IBOutlet UILabel * __null_unspecified label;
@property (nonatomic) IBOutlet UITextField * __null_unspecified inputTextField;
@property (nonatomic) NSInteger countValue;
- (IBAction)pressCountUpBtn:(id __nonnull)sender;
- (IBAction)pressCountDownBtn:(id __nonnull)sender;
- (void)valueUpdate;
- (IBAction)pressShowAlertBtn:(id __nonnull)sender;
- (void)viewDidLoad;
